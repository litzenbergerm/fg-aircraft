...
# std. rate turn bank angle approximation
#
#

var std_rate_bank = func(ias) {
  return ias/10+7
}
...
var incrprop = func (prop, n=1) setprop(prop, getprop(prop) == nil ? 0 : getprop(prop)+n );

var decrprop = func (prop) setprop(prop, getprop(prop) == nil ? 0 : max(0, getprop(prop)-1) );

var incrprop360 = func (prop, n=1) setprop(prop, getprop(prop) == nil ? 360 : math.mod(getprop(prop)+n,360) );
...
io.include(HELIONIXPATH ~ "Nasal/mfd_api.nas");
